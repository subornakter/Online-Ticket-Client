...
const PaymentSuccess = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      <div className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-slate-800 text-center max-w-lg w-full">
        ...
        <p className="mb-8 font-medium text-gray-500 dark:text-gray-400">
          Thank you for choosing <span className="font-bold text-emerald-600">TicketBari</span>. Your transaction has been verified and your ticket is confirmed.
        </p>
