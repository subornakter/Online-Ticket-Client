  ...
  if (!stats) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
        <div className="p-8 text-2xl font-semibold text-gray-600 animate-pulse">
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 md:p-12">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
        {/* Total Bookings */}
        <div className="relative p-8 overflow-hidden transition-all duration-500 transform border shadow-lg bg-white/80 backdrop-blur-xl rounded-3xl hover:scale-105 hover:shadow-2xl border-white/30">
          ...
          <div className="relative z-10 text-center">
            ...
            <h3 className="mb-2 text-2xl font-bold text-gray-800">Total Bookings</h3>
            <p className="mb-2 text-4xl font-extrabold text-yellow-700">
              {stats.totalBookings.toLocaleString()}
            </p>
            <span className="text-gray-500">All your reservations at a glance</span>
          </div>
        </div>
        ...
        <div className="relative p-8 overflow-hidden transition-all duration-500 transform border shadow-lg bg-white/80 backdrop-blur-xl rounded-3xl hover:scale-105 hover:shadow-2xl border-white/30">
          ...
          <div className="relative z-10 text-center">
            ...
            <h3 className="mb-2 text-2xl font-bold text-gray-800">Total Payments</h3>
        ...
        <div className="relative p-8 overflow-hidden transition-all duration-500 transform border shadow-lg bg-white/80 backdrop-blur-xl rounded-3xl hover:scale-105 hover:shadow-2xl border-white/30">
          ...
          <div className="relative z-10 text-center">
            ...
            <h3 className="mb-2 text-2xl font-bold text-gray-800">Total Spent</h3>
